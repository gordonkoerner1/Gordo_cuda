...
def solve_geam(uintptr_t csrRowPtrA_ptr,
    ...
    #print("pBuffer (value)             |", pBuffer)
    print("bufferSize(value)           |", bufferSize)
    ...
    if (NULL != nnzC_Ptr):
        print('NULL != nnzC_Ptr: true') #toubleshooting
        nnzC = nnzC_Ptr[0]
    else:
    ...
    #print some debugging info for geam2Nnz()
    ...
    testout3 = testout1 - testout2
        
        
    print("Status after cusparseXcsrgeam2Nnz:", status)
    print("d_csrRowPtrC (pointer)      |", <uintptr_t>d_csrRowPtrC)
    print("testout1 (value)            |", testout1)
    print("testout2 (value)            |", testout2)
    print("testout3 (value)            |", testout3)
    print("nnzC (pointer)              |", <uintptr_t>nnzC_Ptr)
    print("nnzC (value)                |", nnzC)
    print("baseC (value)               |", baseC)

    #troubleshoot
    print("d_csrRowPtrC pointer before reallocate:   |", <uintptr_t>d_csrRowPtrC)
    print("d_csrColIndC pointer before reallocate:   |", <uintptr_t>d_csrColIndC)
    print("d_csrValC pointer before reallocate:      |", <uintptr_t>d_csrValC)
    ...
    #troubleshoot
    print("d_csrRowPtrC pointer before call to geam2:   |", <uintptr_t>d_csrRowPtrC)
    print("d_csrColIndC pointer before call to geam2:   |", <uintptr_t>d_csrColIndC)
    print("d_csrValC pointer before call to geam2:      |", <uintptr_t>d_csrValC)
    ...
    #troubleshoot
    print("d_csrRowPtrC pointer after geam2:   |", <uintptr_t>d_csrRowPtrC)
    print("d_csrColIndC pointer after geam2:   |", <uintptr_t>d_csrColIndC)
    print("d_csrValC pointer after geam2:      |", <uintptr_t>d_csrValC)
